    ...
    SelectedID : function(component, event, helper) {  
        ...
        if(context=='ProductComp' || context=='RecpProduct' || context=='MRProductInstance')
        {
            ...
            if(component.get("v.recipeChildData")!= null){
                var producedProdId = component.get("v.recpProdID");
                  // alert('msg--------->'+producedProdId);                
            ...
            if(alreadyExists){ 
                ...
                if (objectId.Id!=null) {
                    ...
                    action.setCallback(this, $A.getCallback(function (response) {
                        ...
                        //var selNonStock = response.getReturnValue().product.s2cor__Stock_Item__c;
