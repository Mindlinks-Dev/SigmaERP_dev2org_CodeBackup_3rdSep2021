({
    doInitForCard : function(component, event, helper) 
    {
       var payment = component.get("v.paymentObj");
        ...
        payment.sigmaerpdev__Amount__c = component.get("v.amountTobeCharged");
        payment.sigmaerpdev__Due_Amount__c = component.get("v.amountTobeCharged");
        //alert('payment due ammount::'+payment.sigmaerpdev__Due_Amount__c);
    },
    ...
    save : function(component, event, helper) {
       ...
       //alert('cash recevied ::'+cashReceived);
    ...
    {
        var accountNumber = component.get("v.paymentObj.sigmaerpdev__Credit_CardNumber__c");
