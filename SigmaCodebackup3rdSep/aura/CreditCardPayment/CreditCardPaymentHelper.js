({
	...
	makeChargeAfterValidation : function(component,event)
	{
        ...
        function doPayPalPayment()
        {
            ...
            if(cardsub==true)
            {
                payment.sigmaerpdev__Account_Subscription_Interval__c = orderSFId;
            }else
            {
             payment.sigmaerpdev__Sigma_Order__c = orderSFId;
            }
            payment.sigmaerpdev__Amount__c = chargeAmount;
            payment.sigmaerpdev__Payment_Mode__c = 'Card'; 
            payment.sigmaerpdev__Customer_SFID__c = accountSFId;
            ...
            payment.sigmaerpdev__Amount_Recevied__c = receviedamt;
			payment.sigmaerpdev__Card_Type__c = component.get("v.selectedCardType");
           //alert('cardsub'+cardsub);
             if(cardsub==true)
            {
