        ...
        action.setCallback(this, function (a) {
            ...
            if (state == "SUCCESS") {
                if(a.getReturnValue()!=null)
                {
                    ...
                    console.log('data'+JSON.stringify(accountaddress.Contacts));
                    //alert(accountaddress.sigmaerpdev2__Shipment_Details__r);
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                var completeWrapp = response.getReturnValue();
                 //alert('completeWrapp::'+JSON.stringify(completeWrapp));
                ...
                //alert('orderline@@'+ JSON.stringify(component.get("v.orderLinesData")));
                var orderLines = component.get("v.orderLinesData");
