({
   ...
   // alert('rec'+recordid);
       var producttrans=component.get("v.productTransfers");
       // alert('inside'+JSON.stringify(producttrans));
           var interimListUpdated = JSON.stringify(producttrans);
        ...
        action.setCallback(this,function(res){
           ...
           if(state==="SUCCESS")
           {
               component.set("v.Attachmentdata",res.getReturnValue());
           // alert('value@@'+JSON.stringify(component.get("v.Attachmentdata")));
               var action1 = component.get("c.saveattachment");
               action1.setParams({
                   "attachmentimage" :component.get("v.Attachmentdata")
